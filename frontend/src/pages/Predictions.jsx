  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button className="bg-secondaryAccent hover:bg-secondaryAccent/90 text-white px-4 py-2 rounded-xl font-medium transition-colors flex items-center shadow-[0_0_15px_rgba(139,92,246,0.3)]">
