      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-3">
          ...
          <button 
            ...
            className="bg-success hover:bg-success/90 text-white px-4 py-2 rounded-xl font-medium transition-colors flex items-center shadow-[0_0_15px_rgba(16,185,129,0.3)]"
          >
